...
export const ImageExampleVerticallyAligned = () => (
  <div>
    <div className="ImagesInfo">
      ...
      <span>
        NASA’s Cloud-Aerosol Transport System, or CATS, is a lidar
        remote-sensing instrument that measured atmospheric aerosols and clouds
        from the International Space Station (ISS). The CATS payload improved
        our understanding of aerosol and cloud properties and interactions, as
        well as demonstrated a low-cost, streamlined approach to developing ISS
        science payloads.
      </span>
    </div>
    <Divider />
